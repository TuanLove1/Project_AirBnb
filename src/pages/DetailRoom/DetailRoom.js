            ...
            <div className='grid wide detail__room'>
                ...
                <div className='row'>
                    <div className='col l-7 mf8-7 c-12'>
                        ...
                        <hr className='my-3' />
                        <p><span className='font-bold'>Mô tả</span> : {data?.description.length > 300 ? <span>{data?.description.slice(0, 280)} <a className='text-blue-500'>...Đọc thêm</a></span> : <span>{data?.description}</span>}</p>
